...
public class Main extends JavaPlugin {
	...
	public void onEnable() {
		...
		config.addDefault("interest.autocharge.FixedAmmount", Integer.valueOf(10));
		...
		config.addDefault("cleanup.enable", Boolean.valueOf(false));	
		...
		config.addDefault("cleanup.msg.olderthan.hours", Integer.valueOf(24));
		config.addDefault("cleanup.transactions.olderthan.hours", Integer.valueOf(168));
